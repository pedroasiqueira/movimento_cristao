...
function Rodape({ tags }) {
  ...
  return (
    <div className="mt-10 border-t border-borda pt-6">
      ...
      <Link
        to="/acervo"
        className="flex min-h-12 w-full items-center justify-center gap-2 rounded-lg border-2 border-azul px-5 font-medium text-azul hover:bg-azul hover:text-white sm:w-auto"
      >
